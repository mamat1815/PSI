...
import { LayoutDashboard, Calendar, Settings, LogOut, Star, MessageSquare } from "lucide-react";
...
export default function StudentSidebar() {
    ...
    const navLinks = [
        ...
        { href: "/aspirasi", label: "Aspirasi", icon: MessageSquare },
    ];
                    ...
                    <div className="border-t border-slate-700/25 pt-6 mt-6">
                        <div className="flex items-center gap-4 bg-white/30 rounded-2xl p-4 backdrop-blur-md border border-white/40 shadow-xl max-w-[240px]">
                            ...
                            <div className="flex-grow">
                                ...
                                <p className="text-xs opacity-80 font-[family-name:var(--font-kodchasan)] text-slate-700">Mahasiswa</p>
                            </div>
                            <button 
